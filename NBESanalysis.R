...
nbes_data100_flux <- readRDS('output/nbesSummary_fluct100.RData')
...
nbes_plot_flux$RD[nbes_plot_flux$RD==15] <- 'No RD (Topt = 15)'
...
nbes_plot_combined$RD[nbes_plot_combined$RD==15] <- 'No RD (Topt = 15)'
